...
-- f :: a -> k b
-- traverse f :: g a -> k (g b)
-- traverse (traverse f) :: f (g a) -> k (f (g b))
  traverse f (Compose k) = Compose <$> traverse (traverse f) k
--  traverse f (Compose k) = Compose <$> sequenceA (sequenceA <$> ((f <$>) <$> k))
...
-- Implement the traverse function for a Traversable instance for Product
  traverse k (Product fa ga) = Product <$> traverse k fa <*> traverse k ga
